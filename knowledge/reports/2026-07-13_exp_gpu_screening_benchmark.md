...
## 4b. 第二案泛化(hc02,chain3 phase D,10:24–11:06)

hc02 dump:`gates=132293 bits=21164 cands=640771 cpuScreen64T=11.354s`。
bench v2(cap 4096/8192):flat 1T maxErr=**2.983e-10** ✅ spill 19251(3.0%);
flat 64T 17.06s / 160T 13.84s;GPU FP64 845.3s maxErr=1.9e-10;FP32 = FP64 ×
**1.01**(再證掃描 bound);**FP32 召回 top-1000 100%/100%、top-10000
99.98%/100%**(sign-miss 13.3%,仍全在近零邊緣)。
**兩案同構結論:正確性、FP32 精度背書、掃描瓶頸、分流架構全部泛化。**
