...
mkdir -p $OUT
FROZEN="OMP_NUM_THREADS=$T BANKING_MODE=matching PRODUCTION=1 INCR_RELOC=1 RELOC=1 CRIT_SWAP=1 BIT_REPAIR=1 BIT_REPAIR_DYNA=2 BIT_REPAIR_RESCAN=4 BIT_REPAIR_BATCH=1 REFINE_ALLFF=1 BIT_REPAIR_INTRA=1 ALT_ROUNDS=2 BIT_REPAIR_TIME=1200 ORACLE_REBANK=1 REBANK_TIME=600 DENSITY_REPAIR=1 ORACLE_EJECT=1 EJECT_TIME=180 EVAL_ANCHOR=1 CONV_TERM=1 CONV_RATE=1e-6 ADAPT_STACK=1"
echo "$FROZEN" > $OUT/env_dump.txt
declare -A BREF=(
  [tc2]=705140.829646587   [tc1]=734700023.359553  [hc02]=9678012.79050386
  [hc03]=55771346.6806144  [tc3]=725803320.322809  [hc01]=29993040.5219705
  [hc04]=725980967.603273 )
