...
| Testcase | Baseline | Stage B v2 (Matching) | **Current (DP-v2)** | Delta vs Baseline | Dominant Cost |
|---|---:|---:|---:|---:|---|
| testcase1_0812 | 743,005,833 | 742,555,934 | **741,282,699** | **-0.23%** | Area 99% |
| testcase2_0812 | 830,273 | 815,494 | **799,642** | **-3.69%** | TNS 11% / Power 20% / Area 69% |
| testcase3 | 728,870,766 | 728,538,922 | **728,181,612** | **-0.09%** | Area 100% |
| testcase1_MBFF | 752,479,215 | 748,465,219 | **745,999,703** | **-0.86%** | Area 99% |
| testcase2_MBFF | 865,419 | 846,400 | **827,535** | **-4.38%** | TNS 14% / Power 20% / Area 66% |
| hiddencase01 | 32,732,137 | 31,462,728 | **31,239,556** | **-4.56%** | **Power 96%** |
| hiddencase02 | 13,863,364 | 13,468,811 | **12,589,252** | **-9.19%** | **TNS 34% / Power 62%** |
| hiddencase03 | 55,941,538 | 55,934,849 | **55,917,540** | **-0.04%** | Area 100% |
| hiddencase04 | 729,383,529 | 728,875,222 | **728,590,247** | **-0.11%** | Area 100% |

> Current shipped version: Stage B v2 matching + DP-v2 (K=5 cost-aware GlobalSwap + ChangeCell). Largest gains on TNS/Power cases: hc02 **-9.19%**, hc01 **-4.56%**, t2_MBFF **-4.38%**, t2_0812 **-3.69%**.
...
- **DP-v2** (shipped): K=5 cost-aware GlobalSwap + ChangeCell (OMP race fix)
